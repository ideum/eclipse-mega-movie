...
package ideum.com.eclipsecamera2019.Java.provider.ephemeris;
...
import ideum.com.eclipsecamera2019.Java.Util.MathUtil;
import ideum.com.eclipsecamera2019.Java.Util.MiscUtil;
import ideum.com.eclipsecamera2019.Java.Util.TimeUtil;
import ideum.com.eclipsecamera2019.Java.base.TimeConstants;
import ideum.com.eclipsecamera2019.Java.units.GeocentricCoordinates;
import ideum.com.eclipsecamera2019.Java.units.HeliocentricCoordinates;
...
public enum Planet {
  ...
  private int getLunarPhaseImageId(Date time) {
    ...
    if (phase < 67.5f) {
      // Crescent
      return (phase2 > phase) ? R.drawable.moon : R.drawable.moon;
