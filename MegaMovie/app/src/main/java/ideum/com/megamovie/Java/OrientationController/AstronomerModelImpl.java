...
import ideum.com.megamovie.Java.OrientationController.Clock;
import ideum.com.megamovie.Java.OrientationController.MagneticDeclinationCalculator;
import ideum.com.megamovie.Java.OrientationController.RealClock;
...
public class AstronomerModelImpl implements AstronomerModel {
  ...
  private RaDec getPointingRaDec() {
    return new RaDec(getPointing().getLineOfSight().getRa(),getPointing().getLineOfSight().getDec());
  }
