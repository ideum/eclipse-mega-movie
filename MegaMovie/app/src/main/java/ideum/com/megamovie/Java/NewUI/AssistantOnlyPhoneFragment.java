...
public class AssistantOnlyPhoneFragment extends Fragment {


    public AssistantOnlyPhoneFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_assistant_only_phone, container, false);
